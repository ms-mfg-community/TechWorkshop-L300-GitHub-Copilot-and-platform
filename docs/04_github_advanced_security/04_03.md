...
2. You will see findings from the `ZavaStorefront.csproj` file. If you select the finding you'll see a recommendation to update from .NET 6 to .NET 8. (Note: This upgrade has been completed in the current version of the repository.)
